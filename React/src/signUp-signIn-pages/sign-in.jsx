...
export default function LogIn() {
  return (
    <div className="w-full min-h-screen bg-componentBg-primeryBg relative flex flex-row justify-center items-center overflow-hidden">
      ...
      <div className="w-[65%] flex flex-col items-center justify-end">
        <img
        ...
        /> */}
        <img
          className=" z-10 w-[500px] h-[700px] absolute top-[120px] right-[170px]"
      ...
      <div className="w-[600px] h-[600px] bg-btnColors-Mailblue/15 absolute top-[-250px] right-[-250px] rounded-full blur-[100px]"></div>
