...
//به زودی اسن چارت با بکند و کمی تغییرات تکمیل خواهد شد
    return (
        <div className="flex flex-col justify-between items-start w-full gap-y-4">
            ...
            <div className="w-full bg-componentBg-mainBg rounded-[12px] h-[103px] flex flex-col justify-end items-center p-4 relative">
                <div className="relative w-full flex flex-row justify-center items-center ">
                    ...
                    <div className="flex flex-row justify-center items-center h-[30px] bg-[#912F38] w-[30%] rounded-l-[4px]">
                        <span className="text-textsColor-texts text-nameSize font-medium ">0 - 30 %</span>
                    </div>
                    <div className="flex flex-row justify-center items-center h-[30px] bg-[#926121] w-[50%]">
                        <span className="text-textsColor-texts text-nameSize font-medium ">30 - 80 %</span>
                    </div>
                    <div className="flex flex-row justify-center items-center h-[30px] bg-[#1B776E] w-[20%] rounded-r-[4px]">
                        <span className="text-textsColor-texts text-nameSize font-medium ">80 - 100 %</span>
                    </div>
                </div>
            </div>
        </div>
