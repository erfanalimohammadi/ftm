...
export default function Methods(){
    ...
    return(
        <div className="w-full flex flex-col justify-center items-start gap-y-4">
            <h3 className="text-nameSize text-textsColor-texts font-bold">Choose the payment method</h3>
            ...
            <div className="flex flex-row justify-between items-center w-full">
                ...
                <div className="w-[49%] flex flex-col justify-center items-center rounded-[16px] bg-componentBg-mainBg gap-y-[12px] py-4">
                    ...
                    <div className="w-full flex flex-row justify-center items-center gap-x-1">
                        ...
                        <path d="M8.00065 15.1663C11.6673 15.1663 14.6673 12.1663 14.6673 8.49967C14.6673 4.83301 11.6673 1.83301 8.00065 1.83301C4.33398 1.83301 1.33398 4.83301 1.33398 8.49967C1.33398 12.1663 4.33398 15.1663 8.00065 15.1663Z" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M7.99805 11.833L7.99805 8.49967" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M8.00195 6.5L7.99597 6.5" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>

                        <h4 className="text-nameSize text-textsColor-texts font-medium " >Crypto Supported</h4>
