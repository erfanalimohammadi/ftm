...
export default function Homepage(){
    ...
    const secondSteps = [
        {colors: ['#038781' , '#03878180' , '#03878100'] , naem: "Step 03" , title: "FTMO Trader" , content : "Advancing to another step demonstrates commitment and talent, leading to an FTMO Account with fictitious funds of up to $200,000 in a demo environment. Despite being a demo, FTMO Traders can get reward of up to 90% of simulated profits without risking their capital and access exclusive opportunities, including FTMO Premium Programme." , secondTitle:"FTMO Account" , options: ["FTMO Account with fictitious funds up to $200,000" , "Reward up to 90% of simulated profits" , "Performance Coaching Sessions" , "FTMO Premium Programme" , "All - Trading Tools & Services"]} ,

        {colors: ['#C6571F','#C6571F80','#C6571F00'], naem: "Step 04" , title: "Professional Trader" , content : "The absolute best FTMO Traders can get an opportunity through our Premium Programme to become professional traders in Quantlane, a proprietary trading firm that manages its own real capital. They are a mix of traders, quants, mathematicians, and developers driven by the same passion for the financial markets. This is the final goal of a trading career which FTMO envisioned." , secondTitle:"Quantlane" , options: ["Contract with fixed salary" , "Performance & Mindset coach" , "Institutional Trading Conditions- Spreads, Liquidity, Risk, Framework" , "Custom Platform & Tools"]}
    ]
        ...
        <div className='flex flex-col min-h-screen bg-componentBg-primeryBg justify-start w-full'>
            ...
            <div className="min-w-[250px] max-w-[1376px] flex flex-col justify-start items-center gap-y-[120px] mx-auto mt-[5px]">
                ...
                <div className="w-[85%] flex flex-col justify-between items-center gap-y-8">
                    ...
                    {/* <div className="relative w-[31.47%] rounded-[16px] flex flex-col items-center justify-center overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-b from-[#0C4D9800] via-[#1067CB80] to-[#1481FE]"></div>
                        <div className="relative bg-white w-[98%] h-[99%] rounded-[12px] mx-auto flex items-center justify-center">
                            <div
                            className='relative top-0 left-0 '>
                                <svg
                                className='absolute top-0 left-0'
                                width="368" height="238" viewBox="0 0 368 238" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M196.5 230C240.9 245.781 338 231.976 368 220.202V0H0V220.202C0.333333 204.91 18.7 180.069 615C115 174.289 141 210.274 196.5 230Z" fill="#020822"/>
                                </svg>
                            </div>
                        </div>
                    </div> */}
                        ...
                        >
                            <div className="relative w-full h-full bg-componentBg-mainBg overflow-hidden rounded-[16px] mx-auto">
                                <div className="flex flex-col justify-start items-center w-[98%] gap-y-8  mx-auto h-[237px] relative">
                                    ...
                                    <div className="w-full flex justify-center items-center p-2">
                                        <button className='w-full py-[12px] px-[16px] rounded-lg text-textsColor-texts font-bold bg-btnColors-Mailblue'>LEARN MORE</button>
                                    </div>
